...
| `icon-512.png` | Manifest (`any` + `maskable`); macOS / Linux / Windows window icon (`sourcePng` in [app-window-shared.mjs](../src/app-window-shared.md)) |
...
None. ICO wrapping is covered in [`test/app-window.test.mjs`](../../../test/app-window.test.mjs).
