...
[`test/app-window.test.mjs`](../../../../test/window/app-window.test.mjs) — platform dispatch, kill args, leftovers (not Chrome), install hints, ICO / WebView2 helpers.
