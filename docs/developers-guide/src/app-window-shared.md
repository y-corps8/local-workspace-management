...
**Imports:** [commands.mjs](commands.md) (`APP_ROOT`, `CACHE_DIR`, `OVERVIEW_URL`)
...
| `OVERVIEW_WINDOW_PY` / `_C` / `_CS` | Native sources under `src/` |
...
Covered by [`test/app-window.test.mjs`](../../../test/app-window.test.mjs).
