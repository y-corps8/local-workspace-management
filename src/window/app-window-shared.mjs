...
import { APP_ROOT, CACHE_DIR, OVERVIEW_URL } from "../config/commands.mjs";
...
export const OVERVIEW_WINDOW_PY = path.join(APP_ROOT, "src/window/overview-window.py");
export const OVERVIEW_WINDOW_C = path.join(APP_ROOT, "src/window/overview-window.c");
export const OVERVIEW_WINDOW_CS = path.join(APP_ROOT, "src/window/overview-window.cs");
